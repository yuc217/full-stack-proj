...
const patientEntries = patients.map(p => {
    var _a;
    const patientInfo = (0, utils_1.toNewPatientEntry)(p);
    const validCheck = ((_a = p.entries) === null || _a === void 0 ? void 0 : _a.map(entry => {
        try {
            return utils_1.entrySchema.parse(entry);
        }
        catch (error) {
            console.error(error);
            return;
    ...
    return Object.assign(Object.assign({}, patientInfo), { id: p.id });
});
