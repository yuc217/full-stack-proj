...
describe('favoriteBlog', () => {
    ...
    test('when list has only one blog, makes it the favorite blog', () => {
    ...
    test('a list of blogs find the favorite blog with the most likes', () => {
...
describe('mostBlogs', () => {
    ...
    test('a list of blogs find the author with the most blogs', () => {
...
describe('mostLikes', () => {
    ...
    test('a list of blogs find the author with the most likes', () => {
